...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/format-list-bullets-rtl.js");
...
const buildNestedList = (headings, ListTag) => {
  ...
  headings.forEach(item => {
    ...
    const text = item.isEmpty ? (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("(Empty heading)", "blocklayouts") : (0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_5__.getTextContent)((0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_5__.create)({
...
function Edit({
  ...
  const blocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    ...
    return clientIds.filter(id => id !== clientId).map(id => getBlock(id));
  }, [clientId]);
  const headings = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useMemo)(() => computeOutlineHeadings(blocks, allowedHeadings), [blocks, allowedHeadings]);
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_2__.BlockControls, {
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(_wordpress_components__WEBPACK_IMPORTED_MODULE_6__.PanelBody, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)("div", {
          ...
          help: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)("Enable smooth scrolling when clicking links", "blocklayouts"),
          __nextHasNoMarginBottom: true
        })]
      })
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/blocks/table-of-contents/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/blocks/table-of-contents/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./save */ "./src/blocks/table-of-contents/save.js");
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./block.json */ "./src/blocks/table-of-contents/block.json");
/**
...
/******/ 		var installedChunks = {
/******/ 			"blocks/table-of-contents/index": 0,
/******/ 			"blocks/table-of-contents/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["blocks/table-of-contents/style-index"], () => (__webpack_require__("./src/blocks/table-of-contents/index.js")))
